...
const LoginPage: React.FC = () => {
    ...
    const { isLoginSuccess } = useAppSelector((state: RootState) => state.auth)
        ...
        <div className="flex justify-center items-center h-screen">
            <form className="w-full max-w-[450px] bg-emerald-600 p-5 rounded-lg" onSubmit={handleSubmit}>
                ...
                <div className="mt-5 flex justify-end">
                    <button className="bg-white px-5 py-2 rounded-lg text-emerald-600 text-center font-medium cursor-pointer" type="submit">Login</button>
                </div>
